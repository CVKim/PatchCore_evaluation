...
if __name__ == "__main__":
    ...
    np.random.seed(0)
    batch_size = 5
    score_masks = np.random.rand(batch_size, 10, 10)  # Batch of random values between 0 and 1
    masks_gt = np.random.randint(2, size=(batch_size, 10, 10))  # Batch of random binary values
